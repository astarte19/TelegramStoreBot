...
namespace BotFFlowers
{
	public class MainController : BotController
	{
		...
		string header_tulps = "";
		string header_roses = "";
		string header_equadorroses = "";
		string header_boxes = "";
		string header_bouqets = "";
		string header_baskets = "";
		string header_toys = "";
		string header_baloons = "";
		string header_candy = "";
		string header_cakes = "";
		string header_fruits = "";

		string header_postcards = "";

		//Таблицы
		static string table_tulps = "";
		static string table_roses = "";
		static string table_equadorroses = "";
		static string table_boxes = "";
		static string table_bouqets = "";
		static string table_baskets = "";
		static string table_toys = "";
		static string table_baloons = "";
		static string table_candy = "";
		static string table_cakes = "";
		static string table_fruits = "";
		static string table_postcards = "";
		...
		public void Start()
		{
			SQLiteConnection USER = new SQLiteConnection("Conn");
			USER.Open();
		...
		{
			SQLiteConnection check_connection = new SQLiteConnection("Conn");
		...
		public void ParseItem(string _baseurl, string header, string table_name)
		{
			...
			HtmlNodeCollection PricesElements = HD.DocumentNode.SelectNodes("xpath");
			HtmlNodeCollection TitlesElements = HD.DocumentNode.SelectNodes("xpath");
			HtmlNodeCollection UrlsElements =
				HD.DocumentNode.SelectNodes("xpath");
			...
			switch (table_name)
			{
				case "table":
					for (int i = 0; i < prices.Count; i++)
					{
						...
						add.CommandText = $"INSERT INTO table VALUES(@Id, @Image,@Name,@Price)";
